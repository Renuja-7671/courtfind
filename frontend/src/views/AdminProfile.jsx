...
const AdminProfile = () => {
    ...
    const [userData, setUserData] = useState({
      ...
      lastName: '',
      email: '',
      position: 'System Administrator' // Hardcoded as requested
    });
    ...
    const handleSave = async () => {
      try {
        ...
        // Use the correct endpoint based on your route structure
        const response = await axios.put('http://localhost:8000/api/admin/profile', updatedData);
      ...
      <div className="admin-profile-container">
        ...
        <div className="profile-content">
          <div className="profile-image">
            ...
            <img src="https://png.pngtree.com/png-vector/20220709/ourmid/pngtree-businessman-user-avatar-wearing-suit-with-red-tie-png-image_5809521.png" alt="Profile" />
          </div>
